...
if __name__ == '__main__':
  ...
  rp = RouteProcessor(r"M:\Data\CIFP", "CIFP_220811")
  
  ft.mkdir(r"C:\Data\CIFP\CIFP_220811\routes")
  kml = kml_output.KMLOutput("Routes", r"M:\Data\CIFP\CIFP_220811\routes\routes.kml")
  ...
  while route != False:
    ...
    if route != False:
      ...
      txt = open(r"M:\Data\CIFP\CIFP_220811\routes\{}.txt".format(route_name), "w")
      for wp in route:
